  ...
  return (
    <div ref={ref} className="relative">
      ...
      <button
        ...
        aria-haspopup="true"
      >
        <div className="w-8 h-8 bg-primary-100 text-primary rounded-full flex items-center justify-center text-caption font-bold flex-shrink-0">
          {initials}
        </div>
          ...
          >
            ...
            <div className="px-4 py-3 bg-bg-soft border-b border-border">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-primary-100 text-primary rounded-full flex items-center justify-center text-body font-bold flex-shrink-0">
                  {initials}
                </div>
