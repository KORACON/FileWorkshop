...
const ACTIONS: CapabilityAction[] = [
  ...
  { id: 'pdf-to-txt', name: 'В TXT', description: 'Извлечь текст из PDF', icon: '📝',
    group: 'convert', operationType: 'pdf.to_text', targetFormat: 'txt',
    uiPanel: 'instant', fileFamily: 'pdf', options: [] },
  { id: 'pdf-to-docx', name: 'В DOCX', description: 'PDF → Word', icon: '📝',
    group: 'convert', operationType: 'pdf.to_docx', targetFormat: 'docx',
    uiPanel: 'instant', fileFamily: 'pdf', options: [] },
  { id: 'pdf-to-html', name: 'В HTML', description: 'PDF → HTML', icon: '🌐',
    group: 'convert', operationType: 'pdf.to_html', targetFormat: 'html',
    uiPanel: 'instant', fileFamily: 'pdf', options: [] },
